...
const NivelesIntermedio = () => {
  ...
  const fetchNivelData = async () => {
    try {
      ...
      // Obtener estudiantes del nivel intermedio
      const estudiantesResponse = await nivelesService.getIntermedio();
      console.log('Respuesta de estudiantes nivel intermedio:', estudiantesResponse);
      ...
      try {
        const evaluacionesResponse = await evaluacionesService.getByNivel('Intermedio');
        console.log('Respuesta de evaluaciones nivel intermedio:', evaluacionesResponse);
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>Nivel Intermedio</Typography>
                ...
                <Bar 
                  ...
                  options={{
                    ...
                    plugins: {
                      title: {
                        display: true,
                        text: 'Evaluaciones por Mes - Nivel Intermedio'
                      }
                    }
                  }}
                />
      ...
      {tabValue === 3 && (
        <SubnivelList nivel="Intermedio" />
      )}
    </Box>
  );
};

export default NivelesIntermedio;
