...
const NivelesBasico = () => {
  ...
  const fetchNivelData = async () => {
    try {
      ...
      // Obtener estudiantes del nivel básico
      const estudiantesResponse = await nivelesService.getBasico();
      console.log('Respuesta de estudiantes nivel básico:', estudiantesResponse);
      ...
      try {
        const evaluacionesResponse = await evaluacionesService.getByNivel('Basico');
        console.log('Respuesta de evaluaciones nivel básico:', evaluacionesResponse);
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>Nivel Básico</Typography>
                ...
                <Bar 
                  ...
                  options={{
                    ...
                    plugins: {
                      title: {
                        display: true,
                        text: 'Evaluaciones por Mes - Nivel Básico'
                      }
                    }
                  }}
                />
      ...
      {tabValue === 3 && (
        <SubnivelList nivel="Basico" />
      )}
    </Box>
  );
};

export default NivelesBasico;
